...
# NOTE:
# This enum backs the string on_delete constants defined in aksara.fields.
# Use either the enum or the strings; Aksara normalizes them internally.
