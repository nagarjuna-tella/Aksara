...
def model_to_create_table(model_class) -> str:
    ...
    from aksara.migrations.autodetector import (
        model_to_create_table_operation,
        operations_to_code,
    )

    return operations_to_code([model_to_create_table_operation(model_class)])
...
def models_to_migration_code(models: dict) -> str:
    ...
    """
    from aksara.migrations.autodetector import sort_models_by_fk_dependencies

    operations = []
    for model_class in sort_models_by_fk_dependencies(models):
