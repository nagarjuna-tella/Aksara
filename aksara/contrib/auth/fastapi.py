"""
FastAPI integration helpers for Aksara authentication.

Provides FastAPI dependencies for user authentication.

Usage:
    from fastapi import FastAPI, Depends
    from aksara.contrib.auth import get_current_user
...
from aksara.middleware.context import user_id_var
