...
Custom exception hierarchy for Aksara ORM.
Maps database errors to semantic Aksara exceptions.
"""
...
class ConfigurationError(AksaraError):
    """Raised when Aksara is misconfigured."""
    pass


class DatabaseError(AksaraError):
    """
...
class RestrictedError(AksaraError):
    """
...
def map_database_error(
    ...
    *,
    ...
    """
    Map an asyncpg exception to a Aksara exception.
    ...
    Returns:
        An appropriate Aksara exception
    """
    import asyncpg
