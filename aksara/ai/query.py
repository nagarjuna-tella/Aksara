...
async def execute_ai_query_plan(plan: AiQueryPlan) -> AiQueryResult:
    """
    Execute an AiQueryPlan against the Aksara ORM.
    ...
    # 5. Apply pagination
    # Aksara QuerySet uses limit/offset via slicing or specific methods
...
def get_available_models_for_query() -> List[Dict[str, Any]]:
    ...
    """
    from aksara.registry import get_model_meta
