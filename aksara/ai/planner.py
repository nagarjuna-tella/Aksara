"""
Aksara AI Planner (THE ARCHITECT)
...
1. Fetch context
2. Propose an AiPlan
3. Ask Aksara to execute that plan safely
...
async def _handle_create_model(
    ...
    """
    try:
        from aksara.ai.codegen import AiModelSpec, generate_model_code
...
async def _handle_create_migration(
    ...
    """
    try:
        from aksara.ai.codegen import AiModelSpec, generate_migration_stub
        from aksara.ai.patch import AiPatchOperation, AiPatchRequest, apply_ai_patches
        import os
...
Auto-generated by Aksara AI Planner
"""
...
async def _handle_run_migrations(
    ...
    try:
        ...
        try:
            from aksara.migrations.executor import MigrationExecutor
...
async def _handle_generate_viewset(
    ...
    """
    try:
        from aksara.ai.codegen import AiModelSpec, generate_viewset_code
        from aksara.ai.patch import AiPatchOperation, AiPatchRequest, apply_ai_patches
        import os
...
async def _handle_generate_serializer(
    ...
    """
    try:
        from aksara.ai.codegen import AiModelSpec, generate_serializer_code
        from aksara.ai.patch import AiPatchOperation, AiPatchRequest, apply_ai_patches
        import os
...
async def _handle_generate_admin(
    ...
    """
    try:
        from aksara.ai.codegen import AiModelSpec, generate_admin_code
        from aksara.ai.patch import AiPatchOperation, AiPatchRequest, apply_ai_patches
        import os
