...
# ── Overview / list all models (v0.5.43) ─────────────────────────────────────
_r(r"\bwhat\b.*\bhave\b.*\bsystem\b", "model", "overview_models", 0.88)
_r(r"\bwhat\b.*\bin\b.*\bsystem\b", "model", "overview_models", 0.85)
_r(r"\blist\b.*\bmodel", "model", "overview_models", 0.88)
_r(r"\ball\b.*\bmodel", "model", "overview_models", 0.85)
_r(r"\boverview\b", "model", "overview_models", 0.87)
_r(r"\bwhat\b.*\bmodels\b", "model", "overview_models", 0.82)
_r(r"\bwhat\b.*\bdo\b.*\bhave\b", "model", "overview_models", 0.84)
