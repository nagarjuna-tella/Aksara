...
Aksara 0.7.0rc1 does not ship a public general-purpose `aksara.cache` API. Earlier
...
A framework cache contract remains out of scope for v0.7.0-rc1. Durable
Authorized Operations do not require Redis or a new general cache API.
