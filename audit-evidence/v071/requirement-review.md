...
| A18: CLI discoverability (line 952) | PARTIAL | cli-contract.json inventories 117 command/group declarations; CLI reference and narrower execution gates cover discovery. | Current 302-command parse result excludes 11 forms; callbacks are not all executed. startapp still prints legacy AksaraSettings instructions; correct its instructional text before candidate. |
