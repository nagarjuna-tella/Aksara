...
# Import settings first (configures Aksara)
...
<body>
    <div class="container">
        ...
        <p class="success">Your blog backend is running 🚀</p>
        <div class="links">
            <a href="/admin/">Admin Panel <span>→ Manage posts & comments</span></a>
            <a href="/studio/ui">Studio <span>→ Interactive dashboard</span></a>
            <a href="/api/posts/">Posts API <span>→ /api/posts/</span></a>
            <a href="/api/comments/">Comments API <span>→ /api/comments/</span></a>
