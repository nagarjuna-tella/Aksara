...
def main():
        ...
        for index, python in enumerate((args.baseline_python,args.candidate_python)):
            ...
            for path in project.rglob('*'):
                if path.is_file():
                    ...
                    data=data.replace(b'0.7.2',b'[RELEASE_VERSION]')
    ...
    evidence={'schema_version':1,'pass':True,'packages':packages,'changed_generated_files':changed,
              ...
              'normalization':'Generated Studio token value in .env/.env.example plus exact 0.7.0/0.7.1rc1/0.7.1/0.7.2rc1/0.7.2 version spellings; no other executable/config/dependency normalization',
