...
def main():
    ...
    evidence = {
        ...
        'normalization': 'Generated Studio token in .env/.env.example plus exact 0.7.0/0.7.1rc1/0.7.1/0.7.2rc1/0.7.2 version spellings; no other code/config/default normalization',
