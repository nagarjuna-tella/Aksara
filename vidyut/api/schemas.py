"""
Auto-generated Pydantic Schemas from Vidyut Models
...
def _should_include_in_create(field_name: str, field: vidyut_fields.Field) -> bool:
    """
...
def _should_include_in_update(field_name: str, field: vidyut_fields.Field) -> bool:
    """
...
def _should_include_in_read(field_name: str, field: vidyut_fields.Field) -> bool:
    """
...
def generate_create_schema(model: Type[Model]) -> Type[BaseModel]:
    """
    Generate a Pydantic Create schema for a Vidyut model.
...
def generate_update_schema(model: Type[Model]) -> Type[BaseModel]:
    """
    Generate a Pydantic Update schema for a Vidyut model.
...
def generate_read_schema(model: Type[Model]) -> Type[BaseModel]:
    """
    Generate a Pydantic Read schema for a Vidyut model.
...
def model_to_dict(instance: Model) -> Dict[str, Any]:
    ...
    Args:
        instance: Vidyut model instance
