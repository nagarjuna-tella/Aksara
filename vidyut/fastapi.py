...
Vidyut integration with FastAPI for database lifecycle and session management.
"""
...
from vidyut.db import Database, session_context
...
def init_vidyut(
    ...
    *,
    ...
    """
    Initialize Vidyut with a FastAPI application.
    ...
    Usage:
        app = FastAPI()
        init_vidyut(app, "postgresql://user:pass@localhost/db")
    """
    db = Database(
...
async def get_db_session() -> AsyncGenerator["asyncpg.Connection", None]:
    ...
    Usage:
        ...
        from vidyut.fastapi import get_db_session
...
class VidyutMiddleware:
    ...
    Usage:
        app = FastAPI()
        app.add_middleware(VidyutMiddleware)
    """
