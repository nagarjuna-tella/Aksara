...
Usage:
    ...
    from vidyut.middleware import RequestIDMiddleware, LoggingMiddleware
...
Configuration via vidyut.conf.settings:
...
logger = logging.getLogger("vidyut.request")
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    Configuration:
        Control via vidyut.conf.settings:
