"""
AI Client Protocol for Vidyut.

This module defines the protocol (interface) for LLM clients that can be
used with Vidyut's AI features. External packages (e.g., vidyut-openai,
vidyut-anthropic) can implement this protocol.

Vidyut core does NOT implement any concrete client - this is intentionally
...
class BaseAiClient(Protocol):
    ...
    Usage with Vidyut:
        ...
        from vidyut.ai import get_ai_tools_for_request, export_tools_as_openai_functions
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            tools: Optional list of tool definitions in provider-specific format.
                Vidyut provides exporters for OpenAI, MCP, and generic formats.
