...
from vidyut.ai.registry import get_ai_tools_for_request
from vidyut.ai.exporters import export_tools_as_generic, export_tools_as_mcp
...
async def list_ai_tools_openai(request: Request) -> Dict[str, Any]:
    ...
    """
    from vidyut.ai.exporters import export_tools_as_openai_functions
...
async def get_ai_query_plan_schema() -> Dict[str, Any]:
    ...
    structure query plans that Vidyut can execute.
...
async def execute_query_plan(request: Request) -> Dict[str, Any]:
    ...
    and executes it against the Vidyut ORM, returning serialized results.
...
async def list_queryable_models() -> Dict[str, Any]:
    ...
    """
    from vidyut.ai.query import get_available_models_for_query
...
async def get_ai_codegen_schema() -> Dict[str, Any]:
    ...
    codegen requests that Vidyut can execute.
    ...
    """
    from vidyut.ai.codegen import get_codegen_schemas, AiCodegenTarget, FIELD_TYPE_MAPPING
...
async def codegen_preview(request: Request) -> Dict[str, Any]:
    """
    Generate Vidyut code from a structured specification.
    
    This endpoint receives a codegen request (usually formatted by an LLM)
    and deterministically generates Vidyut-compatible code artifacts.
    ...
    """
    from vidyut.ai.codegen import AiCodegenRequest, generate_code
...
async def get_ai_context_settings(request: Request) -> Dict[str, Any]:
    ...
    """
    from vidyut.ai.context import _extract_settings_info, _extract_middleware_info
    import vidyut
...
async def get_ai_patch_schema() -> Dict[str, Any]:
    ...
    structure patch requests that Vidyut can safely apply.
...
async def get_ai_plan_schema() -> Dict[str, Any]:
    ...
    LLMs/agents can use this schema to understand how to
    structure multi-step plans that Vidyut can execute.
...
async def get_schema_issues(
    ...
    """
    from vidyut.ai.schema_doctor import analyze_schema_health, AiSchemaIssue
