...
class AiToolRegistry:
    ...
    Should be attached to the Vidyut app instance.
...
def _check_requires_auth(permission_classes: List[Type["BasePermission"]]) -> bool:
    ...
    from vidyut.permissions import IsAuthenticated, IsAdminUser, IsActiveUser, IsOwnerOrReadOnly
...
def discover_tools_from_viewset(
    ...
    """
    from vidyut.api.actions import get_action_metadata, is_action_ai_exposed
...
async def get_ai_tools_for_request(
    ...
    Args:
        ...
        app: The Vidyut app instance (must have ai_registry attribute)
    ...
    def get_user():
        ...
        # Try request.state.user first (Vidyut/Starlette style)
