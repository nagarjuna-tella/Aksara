...
This is the single most important foundation for Vidyut as an AI-native
backend framework - giving LLMs complete structured knowledge of your app.

v0.4.3: Initial AI Context Engine release

Usage:
    from vidyut.ai.context import build_full_ai_context, AiFullContext
...
class AiFullContext(BaseModel):
    ...
    # Metadata
    framework: str = Field(default="vidyut", description="Framework identifier")
    framework_version: str = Field(..., description="Vidyut version")
...
def _get_python_type(field: Any) -> str:
    ...
    type_mapping = {
        vidyut_fields.Integer: "int",
        vidyut_fields.String: "str",
        vidyut_fields.Text: "str",
        vidyut_fields.Boolean: "bool",
        vidyut_fields.DateTime: "datetime",
        vidyut_fields.Decimal: "Decimal",
        vidyut_fields.UUID: "UUID",
        vidyut_fields.JSON: "dict",
        vidyut_fields.Email: "str",
        vidyut_fields.URL: "str",
        vidyut_fields.ForeignKey: "int",
        vidyut_fields.Enum: "str",
        vidyut_fields.OneToOne: "int",
        vidyut_fields.ManyToMany: "list",
    }
...
def _extract_viewset_info(viewset_cls: Type["ModelViewSet"]) -> AiViewSetInfo:
    ...
    from vidyut.api.actions import get_action_metadata, is_action
...
def _extract_ai_schemas_info() -> List[AiSchemaInfo]:
    ...
    try:
        # Query plan schema
        from vidyut.ai.query import AiQueryPlan, get_query_plan_schema
...
async def build_full_ai_context(
    ...
    context_data = {
        "framework": "vidyut",
        "framework_version": vidyut.__version__,
