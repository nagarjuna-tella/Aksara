...
Usage:
    from vidyut.ai import AiTool, AiToolRegistry, get_ai_tools_for_request
    from vidyut.ai.exporters import export_tools_as_mcp, export_tools_as_generic
    ...
    # AI Debug (v0.4.1)
    from vidyut.ai.debug import build_ai_debug_context, AiDebugContext
    
    # AI Query Assistant (v0.4.2)
    from vidyut.ai.query import AiQueryPlan, execute_ai_query_plan
    
    # AI CodeGen (v0.4.2)
    from vidyut.ai.codegen import AiModelSpec, generate_code
    
    # AI Context Engine (v0.4.3)
    from vidyut.ai.context import build_full_ai_context, AiFullContext
    
    # AI Patch Engine (v0.4.4)
    from vidyut.ai.patch import apply_ai_patches, AiPatchRequest
    
    # AI Planner (v0.4.5)
    from vidyut.ai.planner import AiPlan, AiPlanStep, execute_plan
    
    # AI Runtime (v0.4.6)
    from vidyut.ai.agent import AgentIntent, AgentContextBundle, build_agent_context_bundle
