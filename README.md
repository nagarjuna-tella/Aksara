...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.5.19-3b82f6?style=flat-square" alt="Version">
...
<table>
  ...
  <tr>
    <td>🧠</td>
    <td><strong>Agent mode</strong> – gather project context and build LLM-ready system prompts via Studio UI, CLI (<code>aksara agent</code>), or Python API</td>
  </tr>
</table>
...
Aksara is **pre-1.0** and actively evolving. Current version: **0.5.19**.
